...
def _get_query():
    ...
    """
    query = Path(__file__).parent.joinpath("./queries/get_surveys_data.gql").open().read()
    return query


DECIDIM_CONN_ID = "api_decidim"
MINIO_CONN_ID = "minio_conn_id"
MINIO_BUCKET = "brasil-participativo-surveys-csv"
LANDING_ZONE_FILE_NAME = "data_survey/surveys.json"

COMPONENT_TYPE_TO_EXTRACT = "Surveys"
QUERY = _get_query()
...
@dag(
    ...
    max_active_runs=1,
    description=__doc__,
    tags=["decidim", "reports", "surveys", "bp"],
    dag_id="etl_surveys",
)
def etl_surveys():

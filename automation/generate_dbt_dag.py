...
def generate_airflow_task(node_type, node_name, dbt_project_path, dbt_profile_path, indentation="    "):
    ...
    packages_path = f"/tmp/dbt_packages_{dbt_command}_{node_name}"
...
&& rm -r {target_path} {packages_path} {logs_path}',
...
{indentation}{indentation}{indentation}'DBT_PACKAGES_INSTALL_PATH': '{packages_path}',

            ...
            data = [
                {
                    ...
                    "sum_visit_length": faker.pyint(
                        min_value=4000000, max_value=40000000
                    ),
            ...
            data = [
                {
                    ...
                    "avg_time_on_site_returning": faker.pyfloat(
                ...
                data.append(
                    {
                        ...
                        "nb_visits_converted": faker.pyint(),
                        "sum_daily_nb_uniq_visitors": faker.pyint(
                            min_value=1000, max_value=50000
                        ),
                        "sum_daily_nb_users": faker.pyint(
                            min_value=1000, max_value=50000
                        ),
            ...
            data = [
                {
                    ...
                    "sum_visit_length": faker.pyint(
                        min_value=4900000, max_value=5000000
                    ),
                    "bounce_count": faker.pyint(min_value=97000, max_value=98000),
                    "nb_visits_converted": 0,
                    "sum_daily_nb_uniq_visitors": faker.pyint(
                        min_value=109000, max_value=110000
                    ),
